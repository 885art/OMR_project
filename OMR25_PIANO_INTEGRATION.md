...
擴充到 20 頁檢查時，發現約 0.40～0.50 的 arpeggio 候選實際是休止符或直線，
而確認正確的垂直波浪琶音記號約為 0.95。因此 arpeggio 的最終採用門檻改為
0.75；這是跨頁面的類別門檻，不是特定圖片座標規則。HTML 總覽也提供固定在
畫面上方、可收合的完整顏色圖例。
