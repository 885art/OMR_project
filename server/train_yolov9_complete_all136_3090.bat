...
set "WEIGHTS=C:\OMR_work\experiments\runs\yolov9_e_deepscores_dense_all136_30ep_b4_3090\weights\best.pt"
...
echo Starting Complete all136 on RTX 3090. This is supported but will be much slower than H100.
