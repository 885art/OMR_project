...
set "RUN_NAME=yolov9_e_symbols_tiny_v2_full_3090"
set "EPOCHS=100"
set "BATCH_SIZE=2"
...
if /I "%~1"=="preflight" (
  echo YOLOv9-E full preflight passed.
  exit /b 0
)

echo Starting YOLOv9-E full: epochs=%EPOCHS% batch=%BATCH_SIZE% imgsz=1024 device=0
